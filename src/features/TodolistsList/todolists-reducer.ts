...
import {fetchTasksTC, fetchTasksTCType} from "./tasks-reducer";
...
export const todolistsReducer = (state: Array<TodolistDomainType> = initialState, action: ActionsType): Array<TodolistDomainType> => {
    switch (action.type) {
        ...
        case "CHANGE-TODOLIST-ANTITY-STATUS":
...
export const changeTodolistEntityStatusAC = (id: string, status: RequestStatusType) => {
    return {
        type: 'CHANGE-TODOLIST-ANTITY-STATUS',
        id,
        status
    } as const
}

export const clearDataTodos = () => {
    return {
        type : 'CLEAR-DATA-TODOS'
    } as const
}


// thunks
export const fetchTodolistsTC = () : fetchTasksTCType => {
    return (dispatch) => {
...
export type clearDataTodosType = ReturnType<typeof clearDataTodos>;
